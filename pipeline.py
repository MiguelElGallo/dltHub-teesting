# Source of this Code > https://dlthub.com/docs/examples/chess_productionhttps://dlthub.com/docs/examples/chess_production
# This code is a part of the DLT Hub documentation. It is a simple example of a chess pipeline that loads data from the chess.com API.  
